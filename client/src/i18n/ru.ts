...
export const ru = {
  ...
  streamerModeLabel: "Стример-режим",
  streamerModeHint: "Скрывает код комнаты и OBS-ссылки на экране.",
  obsLinksTitle: "Различные ссылки",
  overlayViewLinkLabel: "Overlay (просмотр)",
  overlayControlLinkLabel: "Overlay (управление)",
  overlayControlStateLinkLabel: "Overlay API состояния",
  obsLinksLoading: "Загружаем ссылки...",
  obsLinksUnavailable: "Не удалось получить ссылки OBS.",
  ...
  hostMarker: " (ведущий)",
  controlMarker: " (CONTROL)",
  transferHostTitle: "Передать ведущего",
  transferHostSelectPlaceholder: "Нет доступных игроков",
  offlineMarker: " (оффлайн)",
  startButton: "Старт",
  hostOnlyHint: "Только CONTROL может начать игру.",
  ...
  onboardingStep5: "Если включён “Ведущий”, управление фазами идёт через Overlay Control.",
  spectatorLinkTitle: "Зрительский стол (read-only)",
  spectatorLinkHint: "Откройте отдельную страницу зрителя: только просмотр, без управления игрой.",
  externalLinksHint: "Чтобы получить внешнюю ссылку, укажите Domain или Public Host.",
  openButton: "Открыть",
  settingsTitle: "Настройки игры",
  settingsTimersBlock: "Таймеры",
  settingsOtherBlock: "Прочее",
  settingsPresenterMode: "Ведущий",
  settingsPresenterModeHint: "Управление фазами и голосованием через Overlay Control.",
  settingsAutomationMode: "Автоматизация раунда",
  settingsAutomationModeHint:
    "Режимы — это пресеты. Флаги таймеров можно менять в любом режиме, но автозапуск таймеров работает только в «Авто».",
  settingsAutomationAuto: "Авто",
  settingsAutomationSemi: "Полуавто",
  settingsAutomationManual: "Ручной",
  ...
  settingsContinueHost: "Только ведущий",
  ...
  settingsThreatHost: "Только ведущий",
  settingsThreatAnyone: "Любой игрок",
  settingsForcedDisaster: "Катастрофа",
  settingsForcedDisasterRandom: "Рандом",
  presenterControlHint: "Режим ведущего включён: откройте Overlay Control для управления раундами и голосованием.",
  hostMenuTitle: "Меню ведущего",
  hostMenuHintDisabled: "Включите «Ведущий» в лобби, чтобы управлять фазами и голосованием.",
  hostMenuOpenControl: "Открыть Control-пульт",
  hostMenuStartVote: "Старт голосования",
  hostMenuNextStep: "Следующий шаг",
  hostMenuSkipStep: "Пропустить шаг",
  hostMenuEndVote: "Завершить сбор голосов / итоги",
  hostMenuSkipRound: "Пропустить раунд",
  hostMenuKickSelect: "Выберите игрока",
  hostMenuKickPlayer: "Выгнать",
  hostMenuVoteDetails: "Кто в кого проголосовал",
  hostMenuVoteTotals: "Счёт голосов",
  hostMenuNoVotes: "Голосов пока нет.",
  hostMenuNoVoteTotals: "Никто ещё не получил голос.",
  hostMenuVoteTotalRow: (name: string, count: number) => `${name}: ${count}`,
  hostMenuActionFailed: (message: string) => `Команда ведущего отклонена: ${message}`,
  hostMenuActionSuccess: "Команда ведущего отправлена.",
  settingsOn: "вкл",
  settingsOff: "выкл",
  ...
  voteTargetBlockedPlanB: "Нельзя выбрать этого кандидата в переголосовании (План Б).",
  voteTargetBlockedPlanBSuffix: "нельзя (План Б)",
  ...
  hostChangedYou: "Вы стали ведущим.",
  hostChangedOther: (name: string) => `Новый ведущий: ${name}.`,
  transferHostButton: "Передать ведущего",
