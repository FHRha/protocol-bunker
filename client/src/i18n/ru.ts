...
export const ru = {
  ...
  obsLinksTitle: "OBS ссылки",
  overlayViewLinkLabel: "Overlay (View)",
  overlayControlLinkLabel: "Overlay Control",
  overlayControlStateLinkLabel: "Overlay Control State",
  ...
  spectatorLinkTitle: "Ссылка для зрителей (read-only)",
